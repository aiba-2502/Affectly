          ...
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full px-4 py-2 text-sm font-medium text-white bg-[var(--color-primary)] rounded-md hover:bg-[var(--color-primary-hover)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
              >
                ホームに戻る
              </button>
            </div>
